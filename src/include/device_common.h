...
#define CONTROL_STATUS_FREQ_SOURCE	(1 << 31)
#define CONTROL_STATUS_FREQ_SELECT_MASK	(0x3 << 29)
#define CONTROL_STATUS_FREQ_SELECT_SHIFT	(29)
...
#define VTP_CTRL_VAL_DDR3_VTP	0x10107
